...
class GranuleOutputJSON():
    ...
    def checkAll(self, metadata):
        ...
        str = 'GranuleUR'
        try:
            result[str] = self.checkerRules.checkGranuleUR(metadata[str])
        except:
            result[str] = "np"
        ...
        try:
            ...
            if metadata['OnlineAccessURLs'] != None:
                length = len(metadata['OnlineAccessURLs']['OnlineAccessURL'])
                result[str] = self.checkerRules.checkOnlineAccessURLMimeType(metadata['OnlineAccessURLs']['OnlineAccessURL'], length) 
            else:
