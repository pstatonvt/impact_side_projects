...
class GranuleOutputCSV():
    ...
    def checkAll(self, metadata):
        ...
        # ================
        try:
            result += self.checkerRules.checkPlatformShortName(metadata['Platforms']['Platform']['ShortName'],1) + ', '
        except TypeError:
        ...
        # ================
        try:
            result += self.checkerRules.checkOnlineAccessURLMimeType(
            ...
            if metadata['OnlineAccessURLs'] != None:
                ...
                result += "np - reminder: a mime type should be provided for all SERVICE links (Service URL Types in UMM-Common: Access Map Viewer/ Access Mobile App/ Access Web Service/ DIF/ Map Service/ NOMADS/ Opendap Data/ OpenSearch/ SERF/ Software Package/ SSW/ Subsetter/ THREDDS Data)" + ', '
        except KeyError:
            result += "np - reminder: a mime type should be provided for all SERVICE links (Service URL Types in UMM-Common: Access Map Viewer/ Access Mobile App/ Access Web Service/ DIF/ Map Service/ NOMADS/ Opendap Data/ OpenSearch/ SERF/ Software Package/ SSW/ Subsetter/ THREDDS Data)" + ', '
        except:
            result += "np - reminder: a mime type should be provided for all SERVICE links (Service URL Types in UMM-Common: Access Map Viewer/ Access Mobile App/ Access Web Service/ DIF/ Map Service/ NOMADS/ Opendap Data/ OpenSearch/ SERF/ Software Package/ SSW/ Subsetter/ THREDDS Data)" + ', '
        ...
        # ================
        try:
            result += self.checkerRules.checkOnlineResourceMimeType(
